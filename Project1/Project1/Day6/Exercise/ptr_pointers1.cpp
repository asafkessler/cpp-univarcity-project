...
int main()
{
	...
	//that asterisk here is just used to INFORM 
	//about that this variable is a POINTER so it is a 
	//variable that can point to address of another variable
    int * const p = &var; 

	//illegal because p is const
	/*int yyy = 7656;
	p = &yyy;*/
